...
public class Server : MonoBehaviour {
	...
	public void mouseOverShowHand(NetworkMessage m){
		...
		Player tempPlayer = gm.getCurrentPlayer ();
		...
		//SendToClient
		NetworkServer.SendToAll (Msg.mouseOverShowHand, message);
	}

	public void mouseOverShowOther(NetworkMessage m){
		int connectionID = m.ReadMessage<IntegerMessage> ().value;
		StringMessage message = new StringMessage ();
		message.value = gm.getOtherPlayerInfo (gm.getCurrentPlayer ());
		//SendToClient
		NetworkServer.SendToAll(Msg.mouseOverShowOther, message);
	}
	...
	public void checkCardSelection(NetworkMessage m){
		...
		//SendToClient
		NetworkServer.SendToAll(Msg.checkCardSelection, message);
	}
	...
	public void checkCardRemoval (NetworkMessage m){
		...
		message.newState = gm.getUserInputState ();
		//SendToClient
		NetworkServer.SendToAll(Msg.checkCardRemoval, message);
	}
	...
	public void checkButtonClick(NetworkMessage m){
		...
		message.newState = gm.getUserInputState ();
		//SendToClient
		NetworkServer.SendToAll(Msg.checkButtonClick, message);
	}
	...
	public void getUserInputState(NetworkMessage m){
		...
		//SendToClient
		NetworkServer.SendToAll (Msg.getUserInputState, message);
	}
	...
	public void getCurrentPlayer(NetworkMessage m){
		...
		message.rank = tempPlayer.getRank ();
		//SendToClient
		NetworkServer.SendToAll (Msg.getCurrentPlayer, message);
	}
	...
	public void getOtherPlayerInfo(NetworkMessage m){
		...
		//SendToClient
		NetworkServer.SendToAll(Msg.getOtherPlayerInfo, newMessage);
	}
