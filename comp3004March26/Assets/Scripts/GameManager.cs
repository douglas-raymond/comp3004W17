...
//	}
	...
	public void getSponsor(){	
		...
		else
		{
			...
			//replaced by networked solution
	...
	*/
	...
	public Card[] IdentifySelection(string[] selection, int id){
		...
		if (newSelection [selection.Length - 1] != null) {
			Debug.Log ("Selection correctly identified");
		} else {
			Debug.Log ("Selection incorrectly identified");
		}
		return newSelection;
	}
